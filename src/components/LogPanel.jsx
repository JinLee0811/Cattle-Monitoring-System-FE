      ...
      <div className="mb-6">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="text-center">
            <div
              className={`text-2xl font-bold ${
                cameraFilteredLogs.filter((log) => log.severity === "error")
                  .length > 0
                  ? "text-red-400"
                  : "text-gray-400"
              }`}
          ...
          <div className="text-center">
            <div
              className={`text-2xl font-bold ${
                cameraFilteredLogs.filter((log) => log.severity === "warning")
                  .length > 0
                  ? "text-yellow-400"
                  : "text-gray-400"
              }`}
          ...
          <div className="text-center">
            <div
              className={`text-2xl font-bold ${
                cameraFilteredLogs.filter((log) => log.severity === "success")
                  .length > 0
                  ? "text-green-400"
                  : "text-gray-400"
              }`}
          ...
          <div className="text-center">
            <div
              className={`text-2xl font-bold ${
                cameraFilteredLogs.filter((log) => log.severity === "info")
                  .length > 0
                  ? "text-blue-400"
                  : "text-gray-400"
              }`}
